...
# important notes
it is very important for you to be on caution that this software and source code is not completely ready yet. there are factually multiple critical bugs in the software including in a database import/export functionality because the software is new and not perfect. i fix the bug when i find it but it takes many days to weeks time even months time. so you must not use it for professional and real life work and journaling of any kind yet. when the software becomes perfect, i will remove this statement and publish a notice to confirm that the software is perfect and ready.
