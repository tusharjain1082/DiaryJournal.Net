...
namespace EvalScript.Evaluating.Operations
{
    internal static class Plus
    {
        ...
        internal static string Run(string a, string b) => a + b;

        internal static string Run(string a, int b) => a + b;
        internal static string Run(int a, string b) => a + b;

        internal static string Run(string a, long b) => a + b;
        internal static string Run(long a, string b) => a + b;

        internal static string Run(string a, float b) => a + b;
        internal static string Run(float a, string b) => a + b;

        internal static string Run(string a, double b) => a + b;
        internal static string Run(double a, string b) => a + b;

        internal static string Run(string a, decimal b) => a + b;
        internal static string Run(decimal a, string b) => a + b;
