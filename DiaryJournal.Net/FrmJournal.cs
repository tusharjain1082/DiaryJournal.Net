...
namespace DiaryJournal.Net
{
  ...
  //      CoreManaged.CoreManaged cppCore = new CoreManaged.CoreManaged();
        ...
        public void applyConfig()
        {
            ...
            rtbEntry.Document.PageWidth = cfg.cmbCfgRtbEntryRMValue;
            //rtbEntry.RightMargin = cfg.cmbCfgRtbEntryRMValue;
            rtbViewEntry.RightMargin = cfg.cmbCfgRtbViewEntryRMValue;
            int index = cmbCfgRtbEntryRM.FindString(rtbEntry.Document.PageWidth.ToString());
        ...
        public void resetRtb(System.Windows.Controls.WpfRichTextBoxEx rtb, bool clear = true, bool resetSaveState = false)
        {
            ...
            if (clear)
            {
                ...
                flowDoc.PageWidth = (double)cfg.cmbCfgRtbEntryRMValue;
                flowDoc.ColumnWidth = (double)cfg.cmbCfgRtbEntryRMValue;///999999.0;
        ...
        */
        ...
        public void loadSelectedEntry(Int64 id)
        {
            ...
            */
            ...
            FormOperation? formOperation = null;
            formOperation = FormOperation.showForm(this, "please wait. doing operation...", 0, 100, 0, 0);
            formOperation.Tag = id;

            msJournal.Enabled = false;
            this.Enabled = false;
            timerSetRtbEntry.Tag = formOperation;
        ...
        private void buttonApplyConfig1_Click(object sender, EventArgs e)
        {
            ...
            rtbEntry.Document.PageWidth = rtbEntryRightMargin;
            ...
            rtbEntry.reloadIntoNewDocument(cfg.cmbCfgRtbEntryRMValue);
        ...
        private void fontToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            fontDialog.size = rtbEntry.SelectionFontSize;
        ...
        public void store()
        {
            previousXaml = rtbEntry.Xaml;
        }

        public void restore()
        {
            rtbEntry.Xaml = previousXaml;
        }
        ...
        public bool __processSearch()
        {
            ...
            return journalSearchFramework.searchEntries(cfg, ref allNodes, lvSearch, tsSearchProgressBar,
                ...
                chkSearchReplace.Checked, chkSearchReplaceTitle.Checked, chkSearchEmptyString.Checked);
        }
        ...
        private void toolStripMenuItem16_Click(object sender, EventArgs e)
        {
            ...
            __importTheJournalNonCalendarRtfEntries(browseFolder.SelectedPath, input, true);
        }
  ...
  //          if (node == null) return;
    ...
    //        Int64 id = Int64.Parse(treeNode.Name);
        ...
        private void timerSetRtbEntry_Tick(object sender, EventArgs e)
        {
            ...
            FormOperation? form = null;
            if (timerSetRtbEntry.Tag != null)
            {
                form = (FormOperation?)timerSetRtbEntry.Tag;
            }
            else
            {
            ...
            Int64 id = (Int64)form.Tag; //timerSetRtbEntry.Tag;
            myNode? node = entryMethods.FindNodeInList(ref allNodes, id);
            if (node == null)
            {
                timerSetRtbEntry.Stop();
        ...
        {
            formatting.formatSetColumnWidth(rtbEntry);
        }
