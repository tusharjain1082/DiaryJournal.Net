    ...
    public static class journalSearchFramework
    {
            ...
            bool searchReplaceTitle, bool searchEmptyString)
        {
            ...
            if (useCreationDateTimeRange)
            {
                ...
                if (result0 > 0)
                    return false; // error, invalid creation date time input
            ...
            foreach (myNode listNode in allNodes)
            {
                ...
                // user demands emptry string meaning he demands to find entries only by their configuration parameters
