        ...
        */
        ...
        public bool __processSearch()
        {
            ...
            return journalSearchFramework.searchEntries(cfg, ref allNodes, lvSearch, tsSearchProgressBar,
                ...
                chkSearchReplace.Checked, chkSearchReplaceTitle.Checked, chkSearchEmptyString.Checked, (Int64?)txtBoxSearchWhere.Tag);
        }
        ...
        private void tsbuttonResetSearch_Click(object sender, EventArgs e)
        {
            ...
            dtpickerDDSearchFromTime.Value = DateTime.Parse("0:00:00");
            dtpickerDDSearchThroughTime.Value = DateTime.Parse("23:59:59");
            txtBoxSearchWhere.Text = "";
            txtBoxSearchWhere.Tag = null;
        }
  ...
  //          if (node == null) return;
    ...
    //        Int64 id = Int64.Parse(treeNode.Name);
        ...
        public void __selectSearchNode()
        {
            ...
            txtBoxSearchWhere.Text = String.Format("(id:{0}):::{1}", targetNodeId, entryMethods.getEntryLabel(targetNode, false));
            txtBoxSearchWhere.Tag = targetNodeId;
        }
