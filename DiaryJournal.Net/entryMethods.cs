...
namespace DiaryJournal.Net
{
    public static class entryMethods
    {
        ...
        public static List<myNode> DBFindDeletedNodes(myConfig cfg)
        {
            List<myNode> nodes = new List<myNode>();
            List<myNode> allNodes = DBFindAllNodes(cfg, false, false);
            allNodes = DBFindAllNodesTreeSequence(cfg, ref allNodes, true, false);  
        ...
        public static bool DBPromoteNode(myConfig cfg, Int64 id, ref myNode updatedOut)
        {
            // first find the node
            String rtf = "";
            ...
            myNode? parentNode = DBFindLoadNode(cfg, node.chapter.parentId, ref rtf, false);
            if (parentNode == null)
                return false; // error node not found
            ...
            // now update the node
            if (!DBUpdateNode(cfg, ref node, "", false))
                return false;
        ...
        public static bool DBPromoteNodeToRoot(myConfig cfg, Int64 id, ref myNode updatedOut)
        {
            // first find the node
            String rtf = "";
            myNode? node = DBFindLoadNode(cfg, id, ref rtf, false);
        ...
        public static bool DBSetNodeParent(myConfig cfg, Int64 id, ref myNode updatedOut, Int64 parentId = 0)
        {
            // first find the node
            String rtf = "";
            myNode? node = DBFindLoadNode(cfg, id, ref rtf, false);
            ...
            bool result = DBUpdateNode(cfg, ref node, "", false);
            if (result)
                updatedOut = node;
        ...
        public static String DBLoadNodeData(myConfig cfg, Int64 id)
        {
            if (cfg.radCfgUseOpenFileSystemDB)
                return OpenFileSystemDB.loadNodeData(cfg.ctx1, id);
            else
        ...
        public static List<myNode> DBFindAllNodesTreeSequence(myConfig cfg, ref List<myNode> allNodes,
        ...
        public static myNode? DBFindLoadNode(myConfig cfg, Int64 id, ref String rtf, bool loadData = false)
        {
            if (cfg.radCfgUseOpenFileSystemDB)
        ...
        public static List<myNode> DBFindAllChildrenRecursive(myConfig cfg, Int64 id, bool sort = true, bool descending = false)
        {
            ...
            while (queue.Count > 0)
            {
                ...
                List<myNode> children = findFirstLevelChildren(currentNode.chapter.Id, ref srcNodes, sort, descending);

                foreach (myNode childNode in children)
                    queue.Enqueue(childNode);

                if (currentNode.chapter.Id != id)
                    list.Add(currentNode);
            }
            return list;
        }
        // this method finds all lineage chain of a parent node most recursively
        public static List<myNode> FindAllChildrenRecursiveInList(ref List<myNode> allNodes, Int64 id, bool sort = true, bool descending = false)
        {
            List<myNode> list = new List<myNode>();
        ...
        public static List<myNode> findBottomToRootNodesRecursive(ref List<myNode> allNodes, Int64 id, bool deleted = false,
        ...
        public static bool DBDeleteOrPurgeNode(myConfig cfg, ref List<myNode> allNodes, ref myNode node, bool mark = true, bool purge = false)
        {
            ...
            if (!mark)
            {
                ...
                List<myNode> effectedNodes = findBottomToRootNodesRecursive(ref allNodes, node.chapter.Id, true, true);
            ...
            ref List<myNode> nodes, bool mark = true, bool purge = false)
        {
            foreach (myNode listedNode in nodes)
            {
                ...
                if ((mark || purge) || (mark && purge))
                {
                    ...
                    List<myNode> children = FindAllChildrenRecursiveInList(ref allNodes, node.chapter.Id, true, false);
        ...
        public static bool exportEntry(myConfig cfg, Int64 id, String path, bool useCustomPathFileName,
            Int64 exportIndex, EntryType OutputEntryType)
        {
            ...
            String rtf = "";
            myNode? node = DBFindLoadNode(cfg, id, ref rtf, true);
            if (node == null)
                return false;
        ...
        public static bool setEntryHighlightFont(myConfig cfg, Int64 id, Color highlightFontColor, Font highlightFont)
        {
            String HLFont = commonMethods.FontToString(highlightFont);
            String HLFontColor = commonMethods.ColorToString(highlightFontColor);
        ...
        public static bool setEntryHighlightBackColor(myConfig cfg, Int64 id, Color highlightBackColor)
        {
            String HLBackColor = commonMethods.ColorToString(highlightBackColor);
        ...
        public static bool updateHLBackColor(myConfig cfg, Int64 id, String? HLBackColor = null)
        {
            // first find the node
            String rtf = "";
            myNode? node = null;
        ...
        public static bool DBUpdateNodeTitle(myConfig cfg, Int64 id, String title)
        {
            // first find the node
            String rtf = "";
            myNode? node = DBFindLoadNode(cfg, id, ref rtf, false);
        ...
        public static bool updateHLFont(myConfig cfg, Int64 id,
            String? HLFont = null, String? HLFontColor = null, String? HLBackColor = null)
        {
            // first find the node
            String rtf = "";
            ...
            bool sort = true, bool descending = false)
        {
            ...
            // we cannot rebuild and reloop all the nodes indefinately per node down below. so we create the list once and use it indefinately.
            List<myNode> myNodes = new List<myNode>();
        ...
        public static myNode? findNode(List<myNode> nodes, Int64 id)
        {
