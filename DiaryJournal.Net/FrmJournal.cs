...
namespace DiaryJournal.Net
{
    ...
    public partial class FrmJournal : Form
    {
        ...
        private void FrmJournal_Load(object sender, EventArgs e)
        {
            ...
            commonMethods.commonMethods.autoCreateInitLocalPaths();
        ...
        */
        ...
        public void __saveEntry()
        {
            ...
            // save the entry
            entryMethods.DBUpdateNode(cfg, ref node, rtbEntry.Rtf, true, true, true, true);
        ...
        {
            // opens the folder in explorer
            System.Diagnostics.Process.Start("explorer.exe", commonMethods.commonMethods.BackupDirName);
        }

        private void toolStripMenuItem57_Click(object sender, EventArgs e)
        {
            // opens the folder in explorer
            System.Diagnostics.Process.Start("explorer.exe", commonMethods.commonMethods.TempDirName);
        }

        private void toolStripMenuItem56_Click(object sender, EventArgs e)
        {
            commonMethods.commonMethods.autoClearLocalPaths(false, true);
        }

        private void toolStripMenuItem85_Click(object sender, EventArgs e)
        {
            commonMethods.commonMethods.autoClearLocalPaths(true, false);
        }
    }
}