...
namespace DiaryJournal.Net
{
    public class textFormatting
    {
        ...
        public void formatForceRemoveAllFormatting(WpfRichTextBoxEx rtb)
        {
            ...
            rtb.SelectionColor = System.Drawing.Color.Black;
            rtb.SelectionBackColor = System.Drawing.Color.White;
            rtb.SelectionAlignment = TextAlignment.Left;
        }
        ...
        public bool showTableFormattingDialog(WpfRichTextBoxEx rtb, ref TableCell cell, ref FormInsertTable? outForm)
        {
            ...
            rtb.GetDecorations(para, ref underline, ref strikeout);
            /*
            TextRange range = new TextRange(para.ContentStart, para.ContentEnd);
            TextDecorationCollection? decorations = rtb.GetDecorations(range);
            if (decorations != null)
            {
