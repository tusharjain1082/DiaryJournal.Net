    ...
    //                    if (childNode.chapter.IsDeleted)
      //                      continue;
        ...
        public static bool CloneDB(FrmJournal? parentForm,
            String srcPath, String dstPath, String dbName, DatabaseType srcDBType, DatabaseType destDBType, bool loadOperationForm = false)
        {
            ...
            foreach (myNode? listedNode in allNodes)
            {
                ...
                myNode? node = listedNode;
                String rtf = "";
                rtf = entryMethods.DBLoadNodeData(cfgSrc, listedNode.chapter.Id, listedNode.DirectorySectionID);
