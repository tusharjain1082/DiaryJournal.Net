...
namespace DiaryJournal.Net
{
    public class textFormatting
    {
        ...
        public bool formatInsertTableColumn(WpfRichTextBoxEx rtb, bool left)
        {
            ...
            if (userInterface.ShowListInputDialog("insert how many columns?", ref input, ref numColStrings, 0) != DialogResult.OK)
                return false;
        ...
        public bool formatInsertTableRow(WpfRichTextBoxEx rtb, bool above)
        {
            ...
            // ask user
            String input = 1.ToString();
            if (userInterface.ShowListInputDialog("insert how many rows?", ref input, ref numRowsStrings, 0) != DialogResult.OK)
                return false;
