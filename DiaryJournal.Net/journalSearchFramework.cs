...

{
    ...
    {
        public static void __insertLvSearchItem(System.Windows.Forms.ListView lv, ref myNode node, long totalMatches)
        {
            if (node == null)
                return;
        ...
        /// 
        public static bool searchEntries(myConfig cfg, ref List<myNode> allNodes, System.Windows.Forms.ListView lv, ToolStripProgressBar tsProgressBar,
            ...
            bool replace, bool searchReplaceTitle, bool searchEmptyString, Int64? searchNodeID)
        {
            // prepare regex
            ...
            myNode? searchNode = ((searchNodeID != null)
                            ? entryMethods.FindNodeInList(ref allNodes, (Int64)searchNodeID)
                            : null);
            if (searchNode != null)
            {
                // find all children of this node recursively and create their list
                worklist = entryMethods.FindAllChildrenRecursiveInList(ref allNodes, ref searchNode, true, false, true);
            }
