...
namespace DiaryJournal.Net
{
    ...
    public static class OpenFileSystemDB
    {
            ...
            bool create = false)
        {
            ...
            if (overwrite)
            {
                ...
                if (Directory.Exists(dbBasePath))
                    ...
                    //myCommonMethods1.SecureDeleteDirectory(dbBasePath);
        ...
        public static bool CopyDB(ref OpenFSDBContext ctx, String destBasePath, bool copy, bool overwrite)
        {
            ...
            return myCommonMethods1.CopyFilesRecursively(dbBasePath, destBasePath, copy, overwrite);
        }
        ...
        public static bool NodeBackup(OpenFSDBContext ctx, ref myNode node)
        {
            if (node == null)
                return false;
            ...
            commonMethods.commonMethods.autoCreateBackupEntryFile(entryFile, entryConfigFile, DateTime.Now);
            return true;
        }
        ...
        public static bool updateNode(OpenFSDBContext ctx, ref myNode node, String rtf = "", bool storeData = false, bool updateModificationDate = true,
             bool backupOldEntryFirst = false)
        {
            if (node == null)
                return false;
        ...
        public static bool purgeNode(OpenFSDBContext ctx, ref myNode node, bool purgeConfig = true, bool purgeData = true)
        {
            ...
            if (purgeConfig)
                myCommonMethods1.SecureEraseFile(entryConfigFile, 1, true);

            if (purgeData)
                myCommonMethods1.SecureEraseFile(entryFile, 1, true);
