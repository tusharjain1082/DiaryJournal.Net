...
namespace DiaryJournal.Net
{
    public partial class FormInsertTable : Form
    {
        ...
        private void FormInsertTable_Load(object sender, EventArgs e)
        {
            ...
            // configure combo column widths list
            int colwidth = 100;
            cmbColumnWidth.Items.Add(50.ToString());
            for (int j = 0; j < 30; j++)
            {
                cmbColumnWidth.Items.Add(colwidth.ToString());
                colwidth += 100;
            }

            for (int i = 1; i <= WpfRichTextBoxEx.MAX_TABLE_CELLS; i++)
                cmbColumns.Items.Add(i.ToString());
        ...
        private void buttonFont_Click(object sender, EventArgs e)
        {
            ...
            fontDialog.underline = this.Underline;
            fontDialog.strikeout = this.Strikeout;
            ...
            this.Underline = fontDialog.underline;
            this.Strikeout = fontDialog.strikeout;
