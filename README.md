...
# version 1.9.12.0
published 28 January 2024. please note that this version is a major change and LiteDB single file database system used by this application is not allowing me to upgrade past versions database to this latest version, therefore past versions are not compatible with this version, so you must carefully and manually migrate all your past versions entries to this new version, also there are bugs in past versions which have been fixed in this version. upgraded to latest .Net 8.0 (latest version only as available on 15 January 2024 and later). you need .Net 8.0 to run DiaryJournal.Net. major upgrade. major improvements. new additions. everything improved.
