...
namespace EvalScript.Evaluating.Operations
{
    ...
    {
        internal static double Run(int a, int b) => (double)a / b;
        
        internal static double Run(int a, long b) => (double)a / b;
        internal static double Run(long a, int b) => (double)a / b;
        ...
        internal static double Run(long a, long b) => (double)a / b;
