...
//            tsbuttonSave.Checked = true;
        ...
        public void highlightCheckedEntries(bool reset)
        {
            ...
            foreach (TreeNode rootNode in rootNodes)
            {
                ...
                while (queue.Count > 0)
                {
                    ...
                    highlightTreeViewNode(currentNode, fontDialog.Font, fontDialog.Color, reset);
                }
            }
            // refresh 
            //loadEntries();
        ...
        public void highlightTreeViewNode(TreeNode treeNode, Font font, Color color, bool reset)
        {
            Int64 id = Int64.Parse(treeNode.Name);
            myNode? node = entryMethods.FindNodeInList(ref allNodes, id);
            if (node == null)
            ...
            if (reset)
                ...
                entryMethods.setEntryHighlightFont(cfg, ref node, color, font);
