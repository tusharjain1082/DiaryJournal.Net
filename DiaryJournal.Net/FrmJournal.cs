...
namespace DiaryJournal.Net
{
    ...
    public partial class FrmJournal : Form
    {
        ...
        private void FrmJournal_Load(object sender, EventArgs e)
        {
            ...
            dtpickerSearchThroughTime.Value = DateTime.Parse("0:00:00");
        ...
        public void exportEntries(String path, EntryType entryType)
        {
            ...
            foreach (myNode rootNode in rootNodes)
            {
                ...
                while (queue.Count > 0)
                {
                    ...
                    if (!exportEntry(currentNode.chapter, path, exportIndex, entryType))
                        continue;
...
//            tsbuttonSave.Checked = true;
        ...
        public void exportSelectedFreeStandingEntry(EntryType entryType)
        {
            ...
            if (exportEntry(node.chapter, sfdFile.FileName, 0, entryType, true))
            {
            }
        }
        ...
        public void importNewEntry(EntryType entryType, bool freeStandingEntry, bool createNew)
        {
            ...
            // matching file found, import direct
            Chapter? chapter = null;
            chapter = entryMethods.importEntry(ctx, ofdFile.FileName, entryType, default(DateTime), freeStandingEntry, createNew);
            // if error, then skip this file
            if (chapter == null)
                return;
