...
namespace DiaryJournal.Net
{
    public class textFormatting
    {
        ...
        public bool showTableFormattingDialog(WpfRichTextBoxEx rtb, ref TableCell cell, ref FormInsertTable? outForm)
        {
            ...
            Inline? inline = para.Inlines.Where(x => x is Span || x is Inline || x is Run).FirstOrDefault();
            if (inline != null)
            {
            ...
            /*
            // get first inline of first selected cell to use as default
            List<Object>? elements = null;
            rtb.GetAllTextElementsRecursive(cell.Blocks.FirstOrDefault(), out elements, -1, false, false);
            Inline? cellinline0 = (Inline)elements.FirstOrDefault();
            System.Drawing.Color cellfore = (((cellinline0 != null) && (cellinline0.Foreground != null))
                    ? WpfRichTextBoxEx.WpfBrushToWinFormsColor((SolidColorBrush)cellinline0.Foreground)
                    : WpfRichTextBoxEx.WpfBrushToWinFormsColor((SolidColorBrush)cellpara0.Foreground));
            System.Drawing.Color cellbck = (((cellinline0 != null) && (cellinline0.Background != null))
                    ? WpfRichTextBoxEx.WpfBrushToWinFormsColor((SolidColorBrush)cellinline0.Background)
                    : WpfRichTextBoxEx.WpfBrushToWinFormsColor((SolidColorBrush)cellpara0.Background));
            */
