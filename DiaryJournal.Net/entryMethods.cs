    ...
    public static class entryMethods
    {
        ...
        public static String getEntryLabel(myNode node, bool removeInvalidPathChars, bool insertRevDateTime = false)
        {
            ...
            if (insertRevDateTime)
                entryName = commonMethods.commonMethods.getFormattedEntryFileName(entryName, DateTime.Now);
        ...
        public static bool createCoreSystemNodes(ref myConfig cfg, ref List<myNode> allNodes, ref mySystemNodes systemNodes)
        {
            ...
            {
                NodeType nodeType = myCommonMethods1.convertToEnum<NodeType>(systemNodeName);
        ...
        {
            if (cfg.radCfgUseOpenFileSystemDB)
                return OpenFileSystemDB.updateNode(cfg.ctx1, ref node, rtf, storeData, updateModificationDate, backupOldEntryFirst);
            else
                return SingleFileDB.updateNode(cfg.ctx0, ref node, rtf, storeData, updateModificationDate, checkpoint, backupOldEntryFirst);
        }
